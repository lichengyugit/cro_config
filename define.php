...
class DefineConfig {
    ...
    private function setNames() {
        define('APP_CONFIG_NAME', 'cro_config');
        define('APP_AB_NAME', $this->abName);
        define('APP_VIEW_NAME', 'cro_view');
        define('APP_CACHE_NAME', 'cro_cache');
        define('APP_LANG_NAME', 'cro_language');
        define('APP_SYSTEM_NAME', 'cro_framework');
        define('APP_LOG_NAME', 'cro_log');
        define('APP_DAO_NAME', 'cro_dao');
    }
